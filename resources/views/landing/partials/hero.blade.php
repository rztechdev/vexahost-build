    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div class="lg:col-span-7 xl:col-span-7 flex flex-col items-start text-left pt-8 pb-12 sm:pt-12 sm:pb-16 lg:pt-32 lg:pb-20 xl:pt-40 xl:pb-24 w-full max-w-2xl lg:max-w-[620px] xl:max-w-3xl 2xl:max-w-4xl">
                ...
                <p class="rz-after-stream text-base sm:text-lg lg:text-xl text-[#595952] dark:text-zinc-400 font-normal leading-relaxed w-full max-w-xl lg:max-w-[480px] xl:max-w-xl mb-8">
                    Tampil lebih dipercaya di internet. Desain modern, proses cepat, tanpa istilah teknis yang bikin pusing.
                </p>

                <!-- Dual CTA Buttons -->
                <div class="rz-after-stream flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 w-full sm:w-auto" style="animation-delay: 0.15s">
                    <a 
                        ...
                        class="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[#EA580C] hover:bg-[#C2410C] text-white text-xs sm:text-sm font-bold shadow-md shadow-[#EA580C]/20 hover:shadow-lg transition-all duration-200 active:scale-95 group rz-focus-ring"
                    >
                        <!-- WhatsApp Icon -->
