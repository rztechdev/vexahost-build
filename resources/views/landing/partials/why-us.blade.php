    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-2 gap-3 sm:gap-6">
            ...
            <div class="rz-reveal-left rz-delay-1 rz-card-3d bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-3.5 sm:p-6 shadow-sm group flex flex-col justify-between">
                <div>
                    <div class="w-8 h-8 sm:w-11 sm:h-11 rounded-xl bg-[#FB923C]/20 dark:bg-[#FB923C]/15 text-[#EA580C] dark:text-[#FB923C] flex items-center justify-center shrink-0 shadow-xs mb-2.5 sm:mb-4 group-hover:scale-105 transition-transform rz-3d-pop">
